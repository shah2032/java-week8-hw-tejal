...
public class Programme_18_SimpleCalculator {
    //Declare two variables with names firstNumber and secondNumber both of type double.
    double firstNumber;
    double secondNumber;
    ...
    //getAdditionResult Method without any parameters,
    // it needs to return the result of adding the field values of firstNumber and secondNumber.
    public double getAdditionResult() {
        return firstNumber + secondNumber;
    }
  // getSubtractionResult Method without any parameters, it needs to return the result of
  //subtracting the field values of the secondNumber from the firstNumber.
    public double getSubtractionResult() {
        return firstNumber - secondNumber;
    }
   //getMultiplicationResult  Method without any parameters, it needs to return the result
   //of multiplying the field values of firstNumber and secondNumber.
 ...
 //secondNumber is 0 then return 0
    ...
    // Main Method for printing statement
